  ...
  const content = {
    ...
    fr: {
      ...
      principalMessage: {
        ...
        message: "Bienvenue sur le site officiel du Lycée Bilingue d'Ombessa ! A l'ère où le numérique est devenu un mode de penser, d'action et même de vie, il nous a semblé, au Lycée Bilingue d'Ombessa, inopportun de rester à la traine. En effet, la transformation numérique de notre établissement et l'usage à bon escient de l'Intelligence Artificielle nous apparaissent désormais comme un MUST, si nous entendons former des apprenants ouverts au monde et capables de se frayer une voie dans l'immensité des possibilités que leur offrent les nouvelles technologies de l'information et de la communication. La création de ce site vise ainsi à doter notre structure éducative d'un outil moderne d'interaction entre nous mais aussi avec le monde. Il constitue donc une véritable vitrine de notre Lycée, mais aussi un espace d'information, de communication et de valorisation de nos élèves, de nos enseignants et de nos projets. Notre souhait le plus ardent est que ce site offre à nos apprenants de nouvelles possibilités d'apprendre, réussir et envisager leur avenir avec sérénité ; qu'il leur permette d'accéder à plus de ressources de qualité pour mieux accompagner leur parcours. Que nos enseignants trouvent en cet outil des possibilités de développer leurs compétences afin d'envisager la profession enseignante autrement que la traditionnelle image galvaudée que l'on a de ce noble métier et qui le réduit à la simple transmission des connaissances. La communauté éducative et les parents d'élèves trouveront dans cet outil la possibilité de rester informés sur la vie de notre établissement et ainsi d'améliorer le suivi encadrement de leurs enfants à la maison. Enfin, que nos partenaires trouvent ici la possibilité de découvrir nos ambitions et une concrétisation du sérieux qui est le nôtre dans l'œuvre de formation de la jeunesse qui nous est confiée. Ils pourront mieux appréhender nos projets et nous accompagner plus efficacement dans leur réalisation. Les outils numériques et l'intelligence artificielle nous ouvrent de nouvelles possibilités. Utilisons-les avec responsabilité, esprit critique créativité et éthique afin de préparer nos jeunes aux défis du monde de demain. Ensemble faisons du Lycée bilingue d'Ombessa un établissement ouvert, innovant et tourné vers l'avenir.",
        principalName: "Mr ENDONG THOBIAS",
        principalTitle: "Le Proviseur"
      },
      mission: {
        title: "Notre Mission",
        items: [
